        ...
        <div class="container">
            <div class="admin">
                ...
                if ($clients) {
                    ...
                    echo "<th>Email</th>";
                    echo "<th>Phone</th>";
                    echo "<th>Membership_start_date</th>";
                    echo "<th>Membership_end_date</th>";
                    echo "<th>Membership_status</th>";
                    echo "<th>Password</th>";
                    ...
                    while ($client = mysqli_fetch_assoc($clients)) { 
                        ...
                        echo "<td>" . $client['Membership_start_date'] . "</td>";
                        echo "<td>" . $client['Membership_end_date'] . "</td>";
                        echo "<td>" . $client['Membership_status'] . "</td>";
                        echo "<td>" . $client['Password'] . "</td>";
                        echo "<td><a href='add.php?id=" . $client['Id_client'] . "'>Изменить</a> | <a href='php/vendor/delete.php?id=" . $client['Id_client'] . "'>Удалить</a></td>"; // Кнопки "Изменить" и "Удалить"
                        echo "</tr>";
                    }
                    echo "</tbody>";
                    echo "</table>";
                ...
                <div class="inputbox" style="display:flex;">
                    <form class="admin_form" style="margin-right: 250px;" action="php/vendor/create.php" method="POST">
                        ...
                        <p class="admin_form_text">Дата активациии абонемента:</p>
                        <input type="date" name="Membership_start_date">
                        <p class="admin_form_text">Дата дезактивациии абонемента:</p>
                        <input type="date" name="Membership_end_date">
                        <p class="admin_form_text">Статус абонемента:</p>
                        <input type="number" name="Membership_status">
                        <p class="admin_form_text">Пароль:</p>
                    ...
                    <?php
                        ...
                        if (isset($_GET['id'])) {
                            ...
                            $client = mysqli_query($connect, "SELECT * FROM `Clients` WHERE `Id_client` = '$id'");
                            $client = mysqli_fetch_assoc($client);

                            if ($client) {
                                echo "<form class='admin_form' action='php/vendor/update.php' method='POST'>"; 
                                ...
                                echo "<input type='text' name='Name' value='" . $client['Name'] . "'>";

                                echo "<p class='admin_form_text'>Почта:</p>";
                                echo "<input type='text' name='Email' value='" . $client['Email'] . "'>";

                                echo "<p class='admin_form_text'>Телефон:</p>";
                                echo "<input type='text' name='Phone' value='" . $client['Phone'] . "'>";

                                echo "<p class='admin_form_text'>Дата активациии абонемента:</p>";
                                echo "<input type='date' name='Membership_start_date' value='" . $client['Membership_start_date'] . "'>";

                                echo "<p class='admin_form_text'>Дата дезактивациии абонемента:</p>";
                                echo "<input type='date' name='Membership_end_date' value='" . $client['Membership_end_date'] . "'>";

                                echo "<p class='admin_form_text'>Статус абонемента:</p>";
                                echo "<input type='number' name='Membership_status' value='" . $client['Membership_status'] . "'>";
                                echo "<p class='admin_form_text'>Пароль:</p>";
                                echo "<input type='text' name='Password' value='" . $client['Password'] . "'<br> <br>";
