    ...
    <section id="add">
        <div class="container">
            <div class="admin">
                ...
                <p>9. Получить список клиентов, у которых есть активные абонементы, но они еще не посещали ни одну тренировку.</p>
                <?php
                $clients = mysqli_query($connect, "SELECT * FROM nonactiv_client");
                if ($clients) {
                    echo "<table>";
                    echo "<thead>";
                    echo "<tr>";
