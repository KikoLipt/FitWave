    ...
    <section id="add">
        <div class="container">
            <div class="admin">
                ...
                <p>6. Получить список клиентов, имеющих действующую абонементную карту.</p>
                <?php
                $clients = mysqli_query($connect, "SELECT * FROM activ_membership");
                if ($clients) {
                    // Начало таблицы
                    echo "<table>";
                    echo "<thead>";
