    ...
    <section id="add">
        <div class="container">
            <div class="admin">
                ...
                <p>8. Получить список клиентов, у которых истекает срок действия абонемента в ближайшие 7 дней.</p>
                <?php
                $clients = mysqli_query($connect, "SELECT * FROM 12endday");
                if ($clients) {
                    // Начало таблицы
                    echo "<table>";
                    echo "<thead>";
