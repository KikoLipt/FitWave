    ...
    <section id="add">
        <div class="container">
            <div class="admin">
                ...
                <p>7. Получить список клиентов, у которых абонемент истекает в определенном месяце.</p>
                <?php
                $clients = mysqli_query($connect, "SELECT * FROM end_membership");
                if ($clients) {
                    // Начало таблицы
                    echo "<table>";
                    echo "<thead>";
