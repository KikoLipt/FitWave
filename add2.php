    ...
    <section id="add">
        <div class="container">
            <div class="admin">
                ...
                <p>2. Получить список доступных тренировок в определенный день.</p>
                <?php
                $clients = mysqli_query($connect, "SELECT * FROM day_tren");
                if ($clients) {
                    echo "<table>";
                    echo "<thead>";
                    echo "<tr>";
