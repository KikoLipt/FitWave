    ...
    <section id="add">
        <div class="container">
            <div class="admin">
                ...
                <p>10. Получить список тренировок, проводимых в определенном зале и в определенное время.</p>
                <?php
                $clients = mysqli_query($connect, "SELECT * FROM training_list");
                if ($clients) {
                    echo "<table>";
                    echo "<thead>";
                    echo "<tr>";
                    echo "<th>Тренировка:</th>";
                    echo "<th>Тренер:</th>";
                    echo "<th>Дата:</th>";
                    echo "<th>Время:</th>";
                    echo "</tr>";
                    ...
                    while ($client = mysqli_fetch_assoc($clients)) {
                        echo "<tr>";
                        echo "<td>" . $client['тренировка'] . "</td>";
                        echo "<td>" . $client['тренер'] . "</td>";
                        echo "<td>" . $client['дата'] . "</td>";
                        echo "<td>" . $client['время'] . "</td>";
                        echo "</tr>";
                    }
                    echo "</tbody>";
                    echo "</table>";
