    ...
    <section id="add">
        <div class="container">
            <div class="admin">
                ...
                <p>3. Получить список тренеров и их контактной информации.</p>
                <?php
                $clients = mysqli_query($connect, "SELECT * FROM trainer_info");
                if ($clients) {
                    echo "<table>";
                    echo "<thead>";
                    echo "<tr>";
                    echo "<th>id_treiner:</th>";
                    echo "<th>Name:</th>";
                    echo "<th>Email:</th>";
                    echo "<th>Phone:</th>";
                    echo "</tr>";
